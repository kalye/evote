...
public class ListIssuesQuery extends HttpServlet {
	...
	public void doPost( HttpServletRequest  request, HttpServletResponse response ) throws ServletException, IOException{
		...
		try{
		    ...
		    result += "<div class='container'><form method=get action='ListIssuesQuery'><div class='form-group'>" 
		    		+ "<label for='name'>Name:</label> <input type='text' class='form-control' id='search' name='search' placeholder='Search All Issues'></div>"
		    ...
		    if(search.equals("Search All Issues")){
		    	search = "";
		    }
		    ...
		    for(Issue issue: Issues){
		    	...
		    	if(issue.getQuestion().toLowerCase().trim().contains(search.toLowerCase().trim())){
