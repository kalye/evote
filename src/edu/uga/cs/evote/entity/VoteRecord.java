...
public interface VoteRecord extends Persistable
{
    ...
    /** Return the ballotid on which the vote has been cast.
     * @return the id of ballot on which the vote has been cast
     * @throws EVException in case there is a problem with the retrieval of the requested object
     */
    public long getBallotid() throws EVException; 
    
    /** Set the ballotid on which a vote is casted.
     * @param ballotid where new vote was casted on
     * @throws EVException in case there is a problem with setting a link to the argument object
     */
    public void setBallotid(long ballotid) throws EVException; 
    
    /** Return the Voter id who cast the vote.
     * @return the voter id who cast the vote
     * @throws EVException in case there is a problem with the retrieval of the requested object
     */
    public long getVoterid() throws EVException; 
    
    /** Set the ballotid on which the vote has been cast.
     * @param ballotid the new ballot on which the vote has been cast
     * @throws EVException in case there is a problem with setting a link to the argument object
     */
    public void setVoterid(long voterid) throws EVException; 
