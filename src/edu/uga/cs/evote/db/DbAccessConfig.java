...
public abstract class DbAccessConfig
{
    ...
    /** The database name
     */
    static final String DB_NAME        = "team4";
     ...
     */
    static final String DB_CONNECTION_URL = "jdbc:mysql://uml.cs.uga.edu:3306/team4";

    /** The database user name.
     */
    static  String DB_CONNECTION_USERNAME = "team4";
